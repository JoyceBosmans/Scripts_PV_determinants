...
### ----------------------------------------------------------------------------------------------------
polygon_region <- st_read('/vol/milkunB/jbosmans/SolarWindPotentials_NAm/polygon_europe.shp')	# change for other regions!
outputfilename <- 'df_PA_NAm_country_060622.xlsx'												# change for other regions!
region         <- c('Mexico', 'United States', 'Canada')
...
nr_absences      <- 10*nr_presences/0.326 
