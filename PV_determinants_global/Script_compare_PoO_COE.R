...
spearman_cor      <- round(cor(-df_NAm_coarse$COE,df_NAm_coarse$probability,method='spearman'), digits=3)
...
spearman_cor      <- round(cor(-df_SAm_coarse$COE,df_SAm_coarse$probability,method='spearman'), digits=3)
...
spearman_cor      <- round(cor(-df_Eur_coarse$COE,df_Eur_coarse$probability,method='spearman'), digits=3)
...
### ASIA -----------------------------------
extent(raster_Asia_full) <- extent(-180, 180, -11.63333, 81.99996)
x1              <- crop(raster_Asia_full, extent(-180, 0, -11.63333, 81.99996))
x2              <- crop(raster_Asia_full, extent(0, 180, -11.63333, 81.99996))
extent(x1)      <- c(180, 360, -11.63333, 81.99996)
raster_Asia_full_360  <- merge(x1, x2)

raster_Asia_full_360  <- crop(raster_Asia_full_360,extent(20,200,-11.63333, 81.99996))
...
spearman_cor      <- round(cor(-df_Asia_coarse$COE,df_Asia_coarse$probability,method='spearman'), digits=3)
...
### full plot-----------------------------------------------
fullplot <- ggarrange(plot_scatter_NAm,plot_scatter_Eur,plot_scatter_SAm,plot_scatter_Asia,ncol=2,nrow=2)

pdf('Plot_compare_PoO_COE.pdf')
fullplot
dev.off()
