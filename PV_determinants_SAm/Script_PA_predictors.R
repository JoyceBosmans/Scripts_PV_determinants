...
### ----------------------------------------------------------------------------------------------------
polygon_region <- st_read('/vol/milkunB/jbosmans/SolarWindPotentials_SAm/polygon_SAm.shp')	# change for other regions!
outputfilename <- 'df_PA_SAm_country_060622.xlsx'												# change for other regions!
region         <- c('Anguilla' , 'Aruba', 'Bahamas', 'Barbados', 'Belize', 'Bermuda', 'Cayman Islands', 'Costa Rica', 'Dominica', 'Dominican Republic', 'El Salvador', 'Grenada', 'Guadeloupe', 'Guatemala', 'Haiti', 'Honduras', 'Jamaica', 'Martinique', 'Montserrat', 'Netherlands Antilles', 'Nicaragua', 'Panama', 'Puerto Rico', 'Saint Kitts and Nevis', 'Saint Lucia', 'Saint Vincent and the Grenadines', 'Trinidad and Tobago', 'Turks and Caicos Islands', 'British Virgin Islands', 'United States Virgin Islands','Cuba','Paraguay', 'Peru', 'Suriname', 'Uruguay', 'Venezuela','Brazil','Argentina', 'Bolivia', 'Colombia', 'Ecuador', 'Falkland Islands (Malvinas)', 'Guyana','French Guiana','Colombia', 'Ecuador', 'Falkland Islands (Malvinas)', 'Guyana','French Guiana','Chile')
...
outputfilename_stack <- 'predictor_stack_SAm_261121.gri'
