...
df_PA <- read_xlsx('df_PA_SAm_country_060622.xlsx')
...
corvif(df_PA[,c("road_dist","grid_proximity","travel_time", "slope", "elev", "protect_logical", "irradiance", "Agriculture", "Short_natural", "Wetland", "Urban", "Bare", "Water" )])	
...
# --> log_transform travel_time and road_dist and grid and slope. (now also elevation?)
