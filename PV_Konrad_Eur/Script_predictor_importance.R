...
sign                <- if(-0.743 < 0) '#cc3300' else '#3399FF'	# get sign manually from Script_find_best_model.R
...
sign                <- if(-0.396 < 0) '#cc3300' else '#3399FF'	# get sign manually from Script_find_best_model.R
...
sign                <- if(-0.122 < 0) '#cc3300' else '#3399FF'	# get sign manually from Script_find_best_model.R
...
sign                <- if(1.618 < 0) '#cc3300' else '#3399FF'	# get sign manually from Script_find_best_model.R
...
sign                <- if(-0.411 < 0) '#cc3300' else '#3399FF'	# get sign manually from Script_find_best_model.R
df_PI_protect       <- data.frame('Protected status',PI_protect,sign)
...
sign                <- if(0.447 < 0) '#cc3300' else '#3399FF'	# get sign manually from Script_find_best_model.R
...
sign                <- if(0.201 < 0) '#cc3300' else '#3399FF'	# get sign manually from Script_find_best_model.R
...
sign                <- if(-0.045 < 0) '#cc3300' else '#3399FF'	# get sign manually from Script_find_best_model.R
...
# empty ones for predictors not included (so plotting can be consistent for all continents)
...
df_PI
write_xlsx(df_PI,'df_PI_Eur.xlsx')
