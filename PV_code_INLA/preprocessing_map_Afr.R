...
df_allgridcells <- '../../../../Mountpoint3/PV_Konrad_Afr/df_Afr_allgridcells.csv'
...
CRS.new <- CRS("+init=esri:102024") # Lambert projection
...
# select variables
df_PA <- df_full[,c('PA_bool', 'SOVEREIGN1', 'travel_log', 'slope_log', 'elev_log', 'road_log', 'grid_log', 'rsds', 'protect', 'Agriculture', 'Forest', 'Short_natural', 'Wetland', 'Urban', 'Bare', 'Water', 'x_coord', 'y_coord')]
