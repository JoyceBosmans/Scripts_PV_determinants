...
df_allgridcells				<- '/vol/milkunB/jbosmans/PV_Konrad_Eur/df_Eur_allgridcells.csv'
...
CRS.new         <- CRS("ESRI:102014") # Lambert projection
...
foreach(i = 1224:nRuns) %dopar% {
    ...
    # save the model
    save(model, file = paste0(dir_Konrad, "/models/Eur_predictions/", toString(i), ".Rda"))
    ...
    save(df_full_temp, file = paste0(dir_Konrad, "/data/predictions/Eur/", toString(i), ".Rda"))
