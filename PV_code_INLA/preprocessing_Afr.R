...
df_PA <- read_xlsx('../data/xlsx/df_PA_Afr_country.xlsx')
...
df_PA$Forest <- (df_PA$Forest - mean(df_PA$Forest))/sd(df_PA$Forest)
...
# save dataframe
save(df_PA, file = '../data/rda/df_PA_Afr_country_proprocessed.Rda')
