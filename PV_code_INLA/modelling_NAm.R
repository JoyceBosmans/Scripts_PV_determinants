...
load(file = '../data/rda/df_PA_NAm_country_060622_proprocessed.Rda')

# load combs (combinations of variables)
load(file = '../data/rda/var_combs/combinations_NAm.Rda')
...
for (i in 1:nrow(combs)){
    ...
    # write waic to file
    cat(c(i, waic, seeds[i], unlist(combs[i,]), '\n'), file= "../results/waic_NAm.txt",append=TRUE)
    
    # save the model
    save(model, file = paste0("../models/NAm/", toString(i), ".Rda"))
