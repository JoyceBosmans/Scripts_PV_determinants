...
load(file = '../data/rda/df_PA_Asia_country_060622_proprocessed.Rda')

# load combs (combinations of variables)
load(file = '../data/rda/var_combs/combinations_Asia.Rda')
...
for (i in 1:nrow(combs)){
    ...
    # create stack and formula, depending on number of variables in the model
     if (n_vars == 1){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 2){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
     ...
     if (n_vars == 3){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 4){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 5){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 6){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]], V6 = df_PA[,vars[[6]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 7){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]], V6 = df_PA[,vars[[6]]], V7 = df_PA[,vars[[7]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 8){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]], V6 = df_PA[,vars[[6]]], V7 = df_PA[,vars[[7]]], V8 = df_PA[,vars[[8]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 9){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]], V6 = df_PA[,vars[[6]]], V7 = df_PA[,vars[[7]]], V8 = df_PA[,vars[[8]]], V9 = df_PA[,vars[[9]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 10){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]], V6 = df_PA[,vars[[6]]], V7 = df_PA[,vars[[7]]], V8 = df_PA[,vars[[8]]], V9 = df_PA[,vars[[9]]], V10 = df_PA[,vars[[10]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 11){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]], V6 = df_PA[,vars[[6]]], V7 = df_PA[,vars[[7]]], V8 = df_PA[,vars[[8]]], V9 = df_PA[,vars[[9]]], V10 = df_PA[,vars[[10]]], V11 = df_PA[,vars[[11]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 12){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]], V6 = df_PA[,vars[[6]]], V7 = df_PA[,vars[[7]]], V8 = df_PA[,vars[[8]]], V9 = df_PA[,vars[[9]]], V10 = df_PA[,vars[[10]]], V11 = df_PA[,vars[[11]]], V12 = df_PA[,vars[[12]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    if (n_vars == 13){
        stk <- inla.stack(data=list(y = as.integer(df_PA[,1], n = length(df_PA[,1]))),
                            effects=list(c(list(Intercept=1), iset),
                                           list(VC = df_PA[,2], V1 = df_PA[,vars[[1]]], V2 = df_PA[,vars[[2]]], V3 = df_PA[,vars[[3]]], V4 = df_PA[,vars[[4]]], V5 = df_PA[,vars[[5]]], V6 = df_PA[,vars[[6]]], V7 = df_PA[,vars[[7]]], V8 = df_PA[,vars[[8]]], V9 = df_PA[,vars[[9]]], V10 = df_PA[,vars[[10]]], V11 = df_PA[,vars[[11]]], V12 = df_PA[,vars[[12]]], V13 = df_PA[,vars[[13]]]
                                        )
                                    ), 
                            A=list(A,1),
                            tag='fit')
    ...
    # write waic to file
    cat(c(i, waic, seeds[i], unlist(combs[i,]), '\n'), file= "../results/waic_Asia.txt",append=TRUE)
    
    # save the model
    save(model, file = paste0("../models/Asia/", toString(i), ".Rda"))
