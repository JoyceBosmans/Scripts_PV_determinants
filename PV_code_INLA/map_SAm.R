...
df_allgridcells				<- '/vol/milkunB/jbosmans/PV_Konrad_SAm/df_SAm_allgridcells.csv'
...
CRS.new         <- CRS("ESRI:102015") # Lambert projection
...
foreach(i = 1:nRuns) %dopar% {
    ...
    # save the model
    save(model, file = paste0(dir_Konrad, "/models/SAm_predictions/", toString(i), ".Rda"))
    ...
    save(df_full_temp, file = paste0(dir_Konrad, "/data/predictions/SAm/", toString(i), ".Rda"))
