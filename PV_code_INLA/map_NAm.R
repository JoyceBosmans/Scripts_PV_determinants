...
df_allgridcells				<- '/vol/milkunB/jbosmans/PV_Konrad_NAm/df_NAm_allgridcells.csv'
...
CRS.new         <- CRS("ESRI:102009") # Lambert projection
...
foreach(i = 1:nRuns) %dopar% {
    ...
    # save the model
    save(model, file = paste0(dir_Konrad, "/models/NAm_predictions/", toString(i), ".Rda"))
    ...
    save(df_full_temp, file = paste0(dir_Konrad, "/data/predictions/NAm/", toString(i), ".Rda"))
